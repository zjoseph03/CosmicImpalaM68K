...
; Can0_AcceptCode3Reg = ClrByte;
       clr.b     5242918
; Can0_AcceptMask0Reg = ClrByte; // clear acceptance mask registers
       clr.b     5242920
...
; Can1_TxBuffer3 = 0x51; /* data1 = 51 */
       move.b    #81,5243430
; Can1_TxBuffer4 = 0x52; /* data2 = 52 */
       move.b    #82,5243432
; Can1_TxBuffer5 = 0x53; /* data3 = 53 */
       move.b    #83,5243434
; Can1_TxBuffer6 = 0x54; /* data4 = 54 */
       move.b    #84,5243436
; Can1_TxBuffer7 = 0x55; /* data5 = 55 */
       move.b    #85,5243438
; Can1_TxBuffer8 = 0x56; /* data6 = 56 */
       move.b    #86,5243440
; Can1_TxBuffer9 = 0x57; /* data7 = 57 */
       move.b    #87,5243442
