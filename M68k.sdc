...
set_false_path  -from  [get_clocks {b2v_inst7|clockgen_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}]  -to  [get_clocks {speech_subsystem:speech_subsystem_inst|read_address_range:Control_flash_reader|state[5]}]
set_false_path  -from  [get_clocks {speech_subsystem:speech_subsystem_inst|read_address_range:Control_flash_reader|state[5]}]  -to  [get_clocks {b2v_inst7|clockgen_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}]
set_false_path  -from  [get_clocks {b2v_inst7|clockgen_inst|altera_pll_i|general[3].gpll~PLL_OUTPUT_COUNTER|divclk}]  -to  [get_clocks {clk_dram}]
set_false_path  -from  [get_clocks {clk_dram}]  -to  [get_clocks {b2v_inst7|clockgen_inst|altera_pll_i|general[3].gpll~PLL_OUTPUT_COUNTER|divclk}]
